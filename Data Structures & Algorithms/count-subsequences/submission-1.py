class Solution:
    def numDistinct(self, s: str, t: str) -> int:
        ...
        # O(m*n) we will have at most m*n unique states (bounded by indexS and indexT)
        # O(m*n) in space due to the hash map storing m*n states
        memo = {}
