class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def dfs(r, c, index):
            ...
            # backtracking is very important here because maybe one path is not valid but another path is
            # without backtracking, you cannot check other potentially valid paths!
            # board[r][c] = temp
            visited.remove((r,c))
            return False
